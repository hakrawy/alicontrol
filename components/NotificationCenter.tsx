...
const styles = StyleSheet.create({
  ...
  card: { width: '100%', maxWidth: 420, borderRadius: 22, backgroundColor: '#0C111B', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 14, gap: 12, shadowColor: '#000', shadowOpacity: 0.34, shadowRadius: 26, shadowOffset: { width: 0, height: 16 } },
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  titleRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  iconWrap: { width: 38, height: 38, borderRadius: 12, backgroundColor: theme.primary, alignItems: 'center', justifyContent: 'center' },
  ...
  actionBtn: { flex: 1, minHeight: 40, borderRadius: 12, backgroundColor: theme.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  ...
  noteCard: { flexDirection: 'row', gap: 10, borderRadius: 16, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, padding: 12, alignItems: 'flex-start' },
