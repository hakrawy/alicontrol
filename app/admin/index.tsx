...
export default function AdminDashboard() {
  ...
  const copy = language === 'Arabic'
    ? {
        ...
        advancedImports: 'الاستيراد المتقدم',
        playbackSources: 'مصادر التشغيل',
    ...
    : {
        ...
        advancedImports: 'Advanced Imports',
  ...
  const menuItems = [
    ...
    { label: copy.advancedImports, icon: 'publish', route: '/admin/imports', color: '#14B8A6' },
    { label: copy.playbackSources, icon: 'dns', route: '/admin/sources', color: '#F97316' },
