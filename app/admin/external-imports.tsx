...
const styles = StyleSheet.create({
  ...
  providerCard: { flexGrow: 1, minWidth: 150, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 16, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, paddingVertical: 13, paddingHorizontal: 12 },
  ...
  statPill: { borderWidth: 1, borderRadius: 16, paddingVertical: 10, paddingHorizontal: 12, minWidth: 110 },
  ...
  emptyCard: { borderRadius: 20, borderWidth: 1, borderStyle: 'dashed', borderColor: theme.borderLight, backgroundColor: theme.surface, minHeight: 140, alignItems: 'center', justifyContent: 'center', gap: 10, padding: 20 },
  ...
  historyList: { gap: 8 },
  historyItem: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 16, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, padding: 12 },
