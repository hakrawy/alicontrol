...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', alignItems: 'center', gap: 14, borderRadius: 22, padding: 16, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface },
  ...
  summaryCard: { minWidth: 120, flex: 1, borderWidth: 1, borderRadius: 16, padding: 12 },
  ...
  roomCard: { borderRadius: 20, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, padding: 14, gap: 10 },
