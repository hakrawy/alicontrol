...
export default function SeriesScreen() {
  ...
  const sortedSeries = useMemo(
    () => [...allSeries].sort((a, b) => (b.year || 0) - (a.year || 0) || (b.view_count || 0) - (a.view_count || 0)),
    [allSeries]
  );

  const copy = language === 'Arabic'
    ? { title: 'مكتبة المسلسلات', subtitle: `${sortedSeries.length} مسلسل`, series: 'مسلسل' }
    : { title: 'Series Library', subtitle: `${sortedSeries.length} series`, series: 'Series' };
            ...
            >
              ...
              <View style={styles.info}>
                ...
                <View style={styles.metaRow}>
                  ...
                  <Text style={styles.dot}>•</Text>
                  <Text style={styles.meta}>{copy.series}</Text>
                </View>
              </View>
            </Pressable>
          </View>
